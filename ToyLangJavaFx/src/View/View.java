...
public class View {
    ...
    public static void main(String[]args)
    {
            try {
                ...
                IStmt ex13 = new CompSrmt(new VarDeclStmt("a", new IntType()), new CompSrmt(
                        new AssignStmt("a", new ArithExp('+', new ValueExp(new StringValue("a")), new ValueExp(new IntValue(1)))),
    ...
    public static ArrayList<IStmt> getExamples()
    {
        IStmt ex1= new CompSrmt(new VarDeclStmt("v",new IntType()),
                new CompSrmt(new AssignStmt("v",new ValueExp(new IntValue(2))), new PrintStmt(new
                        VarExp("v"))));
        ...
        IStmt ex3 = new CompSrmt(new VarDeclStmt("a",new BoolType()),
                new CompSrmt(new VarDeclStmt("v", new IntType()),
                        new CompSrmt(new AssignStmt("a", new ValueExp(new BoolValue(true))),
                                new CompSrmt(new IfStmt(new RelExp(">",new ValueExp(new IntValue(0)), new VarExp("v")),new AssignStmt("v",new ValueExp(new
                                        IntValue(2))), new AssignStmt("v", new ValueExp(new IntValue(3)))), new PrintStmt(new
                                        VarExp("v"))))));
        ...
        IStmt ex14= new CompSrmt(new VarDeclStmt("a", new IntType()),
                new CompSrmt(
                new ForkStmt(new CompSrmt( new AssignStmt("a", new ValueExp(new IntValue(2))), new PrintStmt(new VarExp("a")))),
                new ForkStmt(new CompSrmt( new AssignStmt("a", new ValueExp(new IntValue(3))), new PrintStmt(new VarExp("a"))))
                ));

        IStmt ex15= new CompSrmt(new VarDeclStmt("a", new RefType(new IntType())),
                new CompSrmt(
                        new ForkStmt(new CompSrmt( new NewStmt("a", new ValueExp(new IntValue(420))), new PrintStmt(new HeapReadingExp(new VarExp("a"))))),
                        new ForkStmt(new CompSrmt( new NewStmt("a", new ValueExp(new IntValue(7))), new PrintStmt(new HeapReadingExp(new VarExp("a")))))
                )
                );

        IStmt ex16=  new CompSrmt(new VarDeclStmt("a", new RefType(new IntType())),
                new CompSrmt(
                        new CompSrmt(new NewStmt("a", new ValueExp(new IntValue(11))), new HWriteStmt("a", new ValueExp(new IntValue(6)))),


                new CompSrmt(
                        new ForkStmt(new CompSrmt( new CompSrmt(new NewStmt("a", new ValueExp(new IntValue(420))),new HWriteStmt("a", new ValueExp(new IntValue(400)))), new PrintStmt(new HeapReadingExp(new VarExp("a"))))),
                        new ForkStmt(new CompSrmt( new CompSrmt(new NewStmt("a", new ValueExp(new IntValue(420))),new HWriteStmt("a", new ValueExp(new IntValue(20)))), new PrintStmt(new HeapReadingExp(new VarExp("a"))))))
        ));

        IStmt ex17 = new CompSrmt(new VarDeclStmt("a",new IntType()), new CompSrmt(new VarDeclStmt("b",new IntType()),
                new CompSrmt(new ForkStmt(new ForkStmt(new PrintStmt(new VarExp("a")))), new ForkStmt(new PrintStmt(new VarExp("b"))))));

        ArrayList<IStmt> result = new ArrayList<IStmt>();
        result.add(ex1);
        result.add(ex2);
        result.add(ex3);
        result.add(ex4);
